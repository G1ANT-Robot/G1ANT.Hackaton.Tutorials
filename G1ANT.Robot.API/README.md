...
amazon-search
AutoSave
azure-text-analytics-rest
Challenge.InputForms.V1
challenge.InvoiceExtraction-V1
Challenge.ShortestPath.V1
---------------------------
...
```G1ANT
call Api query /processes/get method GET parameters name=Notepad
```
...
```G1ANT
call Api query /processes/start method POST parameters name=Notepad
```
...
```G1ANT
call Api query /processes/run method POST parameters name=Hello body ‴addon language version 4.105.0.0‴
```
...
call Api query /processes/put method PUT parameters ‴name=hello‴ body ♥body
```
